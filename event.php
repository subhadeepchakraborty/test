...
<input type="text" id="t1" placeholder="TITLE OF EVENT" name="title_of_event"><br><br><br>
<input type="text" id="t1" placeholder="DESCRIPTION OF EVENT" name="description_of_event" style="height:100px;"><br><br><br>
